...
public class Forcer : MonoBehaviour
{
  ...
  //  public string pubAddress = "tcp://localhost:5523";
    public string subAddress = "tcp://127.0.0.1:7001";
...
//    private float _timeSinceLastPub;
   ...
   // // Update is called once per frame
    private void Update()
    {
        ...
        //       }
        string recvStr;
        //string fromServerMessage = _sub.ReceiveFrameString();
        //Debug.Log(recvStr);
